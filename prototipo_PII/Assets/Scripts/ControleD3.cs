...
public class ControleD3 : MonoBehaviour
{
    ...
    private string[] falas = {
        ...
        "Se gostou? Oxe, gostou demais. Entrou para o meio da festa e foi dançar com os outros orixás. Já Iansã, olhava tudo aquilo de canto. Esperando sua vez de ajudar o tímido Obaluaiê.", 
        "E assim, quando na dança de Obaluaiê ele alcançou o centro do salão, Oiá mandou um vento que levantou as palhas de seu vestido e mostrou a todo mundo a beleza que se escondia por trás delas.", 
        "As chagas de Omulú saltaram transformadas em pipoca, e todos os orixás se admiraram da beleza daquele que se escondia sob as palhas de dendê. E desse dia em diante, todos ficaram sabendo que o que aquelas palhas escondiam não era a feiúra e sim o belo. E muito belo!",
